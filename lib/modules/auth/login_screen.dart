...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _continueAsGuest() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(error.message ?? 'Guest login failed.')),
      );
    } catch (error) {
      if (!mounted) {
        return;
            ...
            FilledButton(
              onPressed: () async {
                ...
                try {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('Unable to send reset email: $error'),
                    ),
                  );
                }
              },
  ...
  Widget build(BuildContext context) {
    final bool anyLoading = _isLoading || _isGoogleLoading || _isGuestLoading;
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    OutlinedButton.icon(
                      onPressed: anyLoading ? null : _googleLogin,
