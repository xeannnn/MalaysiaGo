...
class _GpsCheckInScreenState extends State<GpsCheckInScreen> {
  ...
  Future<void> _fetchSitesForPosition(Position pos) async {
    try {
      ...
      List<HeritageSite> sortedSites = uniqueSites.values
  ...
  void _checkIn(HeritageSite site) {
    ...
    if (!alreadyVisited) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Check-in successful! +${site.xp} XP'),
            ...
            Expanded(
              child: _nearbySites.isEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  // STRICT 100 METERS CHECK-IN THRESHOLD (0.1 KM)
                  final canCheckIn = distKm <= 0.1;
