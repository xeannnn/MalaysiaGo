...
class _HomeScreenState extends State<HomeScreen> {
    ...
    try {
      ...
      if (snapshot.exists) {
        ...
        if (data != null) {
          ...
          if ((data['photoUrl'] as String?)?.trim()?.isNotEmpty ?? false) {
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate XP in current level and total range for this level
    ...
    // States with at least one visit
      ...
      children: [
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              WelcomeCard(
                name: _isLoadingName ? 'Loading...' : _userName,
                photoUrl: _photoUrl,
                onProfileTap: () async {
...
// =====================================================
// Welcome Card – with Clearer XP Progress Display
// =====================================================
